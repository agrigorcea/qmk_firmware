...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QW] = LAYOUT_split(
    ...
    MO(_FN), KC_LGUI, KC_LALT, KC_LCPO, KC_SPC,  MO(_FN),       KC_BSPC, KC_SPC,  KC_RCPC, KC_RALT, KC_RGUI, TG(_FN)
  ),
  ...
  [_FN] = LAYOUT_split( \
    ...
    _______, _______, KC_UP,   C(S(KC_C)), S(KC_INS), KC_GRV,                KC_LBRC, KC_HOME, _______, _______, KC_PSCR, KC_F12,
    _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_ENT,  KC_MINS,               KC_RBRC, KC_END, _______, _______, _______, _______,
    _______, _______, _______, _______, KC_TAB,  KC_EQL,                KC_BSLS,  _______, _______, _______, _______, _______,
